...
const Building_Location = ({ location_data }) => { // Destructure location_data from props
  if (!Array.isArray(location_data)) {
    return <div>Error: location_data is not an array</div>; // Handle the error case
  }
...
export default Building_Location;
